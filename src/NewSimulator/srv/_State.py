"""autogenerated by genpy from NewSimulator/StateRequest.msg. Do not edit."""
import sys
...
class StateRequest(genpy.Message):
  ...
  _type = "NewSimulator/StateRequest"
...
"""autogenerated by genpy from NewSimulator/StateResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class StateResponse(genpy.Message):
  _md5sum = "f26dc0d6a98e4412a2e0d8bc10cd6dc0"
  _type = "NewSimulator/StateResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """StateMessage state


================================================================================
MSG: NewSimulator/StateMessage
...
"""
  __slots__ = ['state']
  _slot_types = ['NewSimulator/StateMessage']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.state is None:
        self.state = NewSimulator.msg.StateMessage()
    else:
      self.state = NewSimulator.msg.StateMessage()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3d2i2dB.pack(_x.state.linear_error.x, _x.state.linear_error.y, _x.state.angular_error, _x.state.timestep, _x.state.reference_id, _x.state.temperature, _x.state.heat, _x.state.in_position))
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state.linear_error.x, _x.state.linear_error.y, _x.state.angular_error, _x.state.timestep, _x.state.reference_id, _x.state.temperature, _x.state.heat, _x.state.in_position,) = _struct_3d2i2dB.unpack(str[start:end])
      self.state.in_position = bool(self.state.in_position)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
